...
#ifndef HEPHAEST_OS_KERNEL_BOOT_IDT_INTERRUPT_HANDLER_H
#define HEPHAEST_OS_KERNEL_BOOT_IDT_INTERRUPT_HANDLER_H
...
#endif// HEPHAEST_OS_KERNEL_BOOT_IDT_INTERRUPT_HANDLER_H
