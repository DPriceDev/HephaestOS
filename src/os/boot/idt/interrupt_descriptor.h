...
#ifndef HEPHAEST_OS_KERNEL_BOOT_IDT_INTERRUPT_DESCRIPTOR_H
#define HEPHAEST_OS_KERNEL_BOOT_IDT_INTERRUPT_DESCRIPTOR_H
...
#endif// HEPHAEST_OS_KERNEL_BOOT_IDT_INTERRUPT_DESCRIPTOR_H
