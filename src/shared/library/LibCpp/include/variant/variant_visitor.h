...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_CPP_VARIANT_VISITOR_H
#define HEPHAEST_OS_SHARED_LIBRARY_CPP_VARIANT_VISITOR_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_CPP_VARIANT_VISITOR_H
