...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_CPP_VARIANT_VARIANT_H
#define HEPHAEST_OS_SHARED_LIBRARY_CPP_VARIANT_VARIANT_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_CPP_VARIANT_VARIANT_H
