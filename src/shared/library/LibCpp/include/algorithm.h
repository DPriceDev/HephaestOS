...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_LIB_CPP_ALGORITHMS_H
#define HEPHAEST_OS_SHARED_LIBRARY_LIB_CPP_ALGORITHMS_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_LIB_CPP_ALGORITHMS_H
