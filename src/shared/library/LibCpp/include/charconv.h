...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_CPP_STRING_CHARCONV_H
#define HEPHAEST_OS_SHARED_LIBRARY_CPP_STRING_CHARCONV_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_CPP_STRING_CHARCONV_H