...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_INT_FORMATTER_H
#define HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_INT_FORMATTER_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_INT_FORMATTER_H
