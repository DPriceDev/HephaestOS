...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_PARSE_STATE_H
#define HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_PARSE_STATE_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_PARSE_STATE_H