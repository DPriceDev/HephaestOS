...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_FORMAT_FORMAT_H
#define HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_FORMAT_FORMAT_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_FORMAT_FORMAT_H
