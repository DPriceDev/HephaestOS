...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_FORMAT_ARGUMENT_H
#define HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_FORMAT_ARGUMENT_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_FORMAT_ARGUMENT_H
