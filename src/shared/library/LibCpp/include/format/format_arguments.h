...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_FORMAT_ARGUMENTS_H
#define HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_FORMAT_ARGUMENTS_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_CPP_FORMAT_FORMAT_ARGUMENTS_H
