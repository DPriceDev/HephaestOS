...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_CPP_ITERATORS_INCREMENTABLE_TRAITS_H
#define HEPHAEST_OS_SHARED_LIBRARY_CPP_ITERATORS_INCREMENTABLE_TRAITS_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_CPP_ITERATORS_INCREMENTABLE_TRAITS_H
