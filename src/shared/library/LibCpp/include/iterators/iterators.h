...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_LIB_CPP_ITERATORS_ITERATORS_H
#define HEPHAEST_OS_SHARED_LIBRARY_LIB_CPP_ITERATORS_ITERATORS_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_LIB_CPP_ITERATORS_ITERATORS_H
