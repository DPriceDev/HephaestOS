...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_LIB_CPP_ITERATORS_REVERSE_ITERATOR_H
#define HEPHAEST_OS_SHARED_LIBRARY_LIB_CPP_ITERATORS_REVERSE_ITERATOR_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_LIB_CPP_ITERATORS_REVERSE_ITERATOR_H
