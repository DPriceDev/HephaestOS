...
#ifndef HEPHAEST_OS_SHARED_LIBRARY_CPP_STRING_VIEW_H
#define HEPHAEST_OS_SHARED_LIBRARY_CPP_STRING_VIEW_H
...
#endif// HEPHAEST_OS_SHARED_LIBRARY_CPP_STRING_VIEW_H